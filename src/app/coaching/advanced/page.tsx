...
import { coachingProgrammes } from "@/lib/coaching/programmes";

const programme = coachingProgrammes.advanced;

export const metadata: Metadata = {
  title: "Advanced Coaching Programme Registration | Indian Mahjong Association",
  description:
    "Register for the Advanced Coaching Programme with the Indian Mahjong Association.",
};

export default function AdvancedCoachingPage() {
  return (
      ...
      <section className="relative overflow-hidden bg-[#f5f0e8]">
        ...
        <div className="relative z-10 mx-auto grid max-w-[72rem] gap-6 px-7 pb-16 pt-8 sm:px-8 sm:pt-10 lg:grid-cols-[300px_minmax(0,1fr)] lg:gap-12 lg:px-16 lg:pb-24 lg:pt-12 xl:grid-cols-[320px_minmax(0,1fr)] xl:gap-14">
          <div className="flex flex-col gap-3">
            ...
            <aside className="h-fit overflow-hidden rounded-[0.75rem] border border-[#7c1f2d]/30 bg-[linear-gradient(180deg,rgba(252,248,241,0.88),rgba(248,244,234,0.74))] shadow-[inset_0_0_0_1px_rgba(255,255,255,0.42),0_4px_24px_rgba(110,79,47,0.08)]">
              <div className="h-[3px] bg-[linear-gradient(90deg,rgba(124,31,45,0),rgba(124,31,45,0.82)_18%,rgba(124,31,45,0.82)_82%,rgba(124,31,45,0))]" />
              <div className="px-6 py-6 sm:px-8 sm:py-7">
                <p className="text-[0.62rem] uppercase tracking-[0.28em] text-[#8f2432]">
                ...
                <div className="mt-5 space-y-2 border-y border-[#c6a87a]/22 py-4 text-[0.78rem] uppercase tracking-[0.18em] text-[#6f5848]">
                  <p>{programme.duration}</p>
                  <p>{programme.format}</p>
                </div>
                <p className="mt-4 text-[0.94rem] leading-[1.72] text-[#5d4d40]">
                  Complete your details below to register your interest and begin
                  programme payment.
                </p>
                <a
                  href="/#membership"
          ...
          <article className="overflow-hidden rounded-[0.75rem] border border-[rgba(198,168,122,0.30)] bg-[linear-gradient(180deg,rgba(252,248,241,0.88),rgba(248,244,234,0.74))] shadow-[inset_0_0_0_1px_rgba(255,255,255,0.42),0_4px_24px_rgba(110,79,47,0.08)]">
            ...
            <div className="px-6 py-7 sm:px-9 sm:py-9 lg:px-12 lg:py-10">
              ...
              <p className="mt-3 max-w-[48ch] text-[1rem] leading-[1.78] text-[#5d4d40]">
                These details help IMA prepare your coaching registration and
                guide you toward the right instruction, pace and table practice.
              </p>

              <div className="mt-6">
                <MembershipRegistrationForm programmeId="advanced" />
              </div>
            </div>
          </article>
        </div>
